...
public class ActitimeTaskvalidation {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		wait.until(ExpectedConditions.elementToBeClickable(By.cssSelector(".basicLightboxFooter .buttonsBox .components_button_label")));
		driver.findElement(By.cssSelector(".basicLightboxFooter .buttonsBox .components_button_label")).click();
	    //click on create task btn
		driver.findElement(By.cssSelector(".basicLightboxFooter .buttonsBox .components_button_label")).click();
		Thread.sleep(3000);
		List<WebElement> taskIsPresent=driver.findElements(By.cssSelector(".taskRow .names"));
		for(int i=0;i<project.size();i++) { 
